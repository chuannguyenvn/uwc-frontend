...
namespace UI.Views.Messaging.Inbox
{
    public class InboxHeader : AdaptiveElement
    {
        ...
        private void CreateBackButton()
        {
            ...
            {
                _backButton.RegisterCallback<ClickEvent>(_ => { GetFirstAncestorOfType<MessagingView>().MobileShowContactList(); });
                RootController.BackButtonPressed += () => { GetFirstAncestorOfType<MessagingView>().MobileShowContactList(); };
            }
